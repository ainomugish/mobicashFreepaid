 ...
 * 
 */
@WebService(name = "airtimeplusPortType", targetNamespace = "http://ws.dev.freepaid.co.za/airtimeplus/")
...
public interface AirtimeplusPortType {
     ...
     *     returns za.co.freepaid.dev.ws.airtimeplus.FetchOrderOut
     */
    @WebMethod(action = "http://ws.dev.freepaid.co.za/airtimeplus/fetchOrderLatest")
    @WebResult(name = "reply", partName = "reply")
     ...
     */
    @WebMethod(action = "http://ws.dev.freepaid.co.za/airtimeplus/queryOrder")
    @WebResult(name = "reply", partName = "reply")
    ...
    /**
     * Fetch list of products. 'user' is your user number and 'pass' is your password. 'status' will always contain the result of the request: 1 = success, 0 = failure. 'errorcode' is a secondary code describing e.g. why a request failed. 'message' is an extended status message. 'balance' is your current balance, assuming it got that far in the request. 'products' is a list of products. Note that the cost price is not always available and will be shown as a 0 when not known. For sample code, please visit http://ws.dev.freepaid.co.za/airtimeplus/sample.html
     * 
     * @param request
     * @return
     *     returns za.co.freepaid.dev.ws.airtimeplus.FetchProductsOut
     */
    @WebMethod(action = "http://ws.dev.freepaid.co.za/airtimeplus/fetchProducts")
    @WebResult(name = "reply", partName = "reply")
